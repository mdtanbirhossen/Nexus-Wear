          ...
          <div className="w-full pb-6">
               ...
               <div className="flex flex-wrap gap-3  items-center justify-between mb-4 w-auto">
                    ...
                    <div className="flex gap-3 items-center">
                         ...
                         <Button 
                              onClick={() => router.push("/management/color/create")}
                    ...
                    <Table>
                         <TableHeader>
                              <TableRow>
                                   ...
                                   <TableHead className="font-extrabold text-center text-secondary">CreatedAt</TableHead>
                                   ...
                                   colors.map((color, idx) => (
                                        <TableRow key={color.id}>
                                             ...
                                             <TableCell>
                                                  {/* Edit */}
                                                  <Button
                                                       onClick={() => router.push(`/management/color/update/${color.id}`)}
                                                       variant="ghost"
                                                  ...
                                                  {/* Details */}
                                                  <Button
                                                       onClick={() => router.push(`/management/color/details/${color.id}`)}
                                                       variant="ghost"
                                                       className="h-8 w-8 p-0"
                                                  >
                                                       <Eye />
