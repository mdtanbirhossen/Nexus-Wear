          ...
          <div className="w-full pb-6">
               ...
               <div className="flex flex-wrap gap-3  items-center justify-between mb-4 w-auto">
                    ...
                    <div className="flex gap-3 items-center">
                         ...
                         <Button onClick={() => router.push("/management/role/create")}>
                              Add Role
                         </Button>
                    </div>
               </div>
                                   ...
                                   roles.map((role, idx) => (
                                        <TableRow key={role.id}>
                                             ...
                                             <TableCell>
                                                  {/* Edit */}
                                                  <Button
                                                       onClick={() => router.push(`/management/role/update/${role.id}`)}
                                                       variant="ghost"
                                                  ...
                                                  {/* Details */}
                                                  <Button
                                                       onClick={() => router.push(`/management/role/details/${role.id}`)}
                                                       variant="ghost"
                                                       className="h-8 w-8 p-0"
                                                  >
                                                       <Eye />
