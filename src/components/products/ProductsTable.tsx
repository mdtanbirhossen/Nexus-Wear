          ...
          <div className="w-full pb-6">
               ...
               <div className="w-full overflow-x-auto rounded-md border text-center">
                    <Table>
                         <TableHeader>
                              <TableRow>
                                   <TableHead className="font-extrabold text-center text-secondary">*</TableHead>
                                   <TableHead className="font-extrabold text-secondary">Image</TableHead>
                                   <TableHead className="font-extrabold text-center text-secondary">Name</TableHead>
                                   <TableHead className="font-extrabold text-center text-secondary">Product Code</TableHead>
                                   <TableHead className="font-extrabold text-center text-secondary">Description</TableHead>
                                   <TableHead className="font-extrabold text-center text-secondary">Price</TableHead>
                                   <TableHead className="font-extrabold text-center text-secondary">Availability</TableHead>
                                   <TableHead className="font-extrabold text-center text-secondary">Colors</TableHead>
                                   <TableHead className="font-extrabold text-center text-secondary">Sizes</TableHead>
                                   <TableHead className="font-extrabold text-center text-secondary">View Count</TableHead>
                                   <TableHead className="font-extrabold text-center text-secondary">Actions</TableHead>
                              </TableRow>
                         </TableHeader>
                                   ...
                                   products?.map((product, idx) => (
                                        <TableRow key={product.id}>
                                             ...
                                             <TableCell>
                                                  {/* Edit */}
                                                  <Button
                                                       onClick={() => router.push(`/management/products/update/${product.id}`)}
                                                       variant="ghost"
                                                  ...
                                                  {/* Details */}
                                                  <Button
                                                       onClick={() => router.push(`/management/products/details/${product.id}`)}
                                                       variant="ghost"
                                                       className="h-8 w-8 p-0"
                                                  >
                                                       <Eye />
