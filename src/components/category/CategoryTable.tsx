                    ...
                    <Table>
                         <TableHeader>
                              <TableRow>
                                   ...
                                   <TableHead className="text-center font-extrabold text-secondary">Total SubCategories</TableHead>
                                   ...
                                   categories.map((category, idx) => (
                                        <TableRow key={category.id}>
                                             ...
                                             <TableCell>
                                                  {/* Edit */}
                                                  <Button
                                                       onClick={() => router.push(`/management/categories/update/${category.id}`)}
                                                       variant="ghost"
                                                  ...
                                                  {/* Details */}
                                                  <Button
                                                       onClick={() => router.push(`/management/categories/details/${category.id}`)}
                                                       variant="ghost"
                                                       className="h-8 w-8 p-0"
                                                  >
                                                       <Eye />
