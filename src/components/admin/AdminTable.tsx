          ...
          <div className="w-full pb-6">
               ...
               <div className="flex flex-wrap gap-3  items-center justify-between mb-4 w-auto">
                    ...
                    <div className="flex gap-3 items-center">
                         ...
                         <Button onClick={() => router.push("/management/admin/create")}>
                              Add Admin
                         </Button>
                    </div>
               </div>
                                   ...
                                   admins.map((admin, idx) => (
                                        <TableRow key={admin.id}>
                                             ...
                                             <TableCell>
                                                  {/* Edit */}
                                                  <Button
                                                       onClick={() => router.push(`/management/admin/update/${admin.id}`)}
                                                       variant="ghost"
                                                  ...
                                                  {/* Details */}
                                                  <Button
                                                       onClick={() => router.push(`/management/admin/details/${admin.id}`)}
                                                       variant="ghost"
                                                       className="h-8 w-8 p-0"
                                                  >
                                                       <Eye />
